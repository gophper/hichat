...
export default {
  ...
  components: {
    SpinnerSnake: require('./lib/snake.vue'),
    SpinnerDoubleBounce: require('./lib/double-bounce.vue'),
    SpinnerTripleBounce: require('./lib/triple-bounce.vue'),
    SpinnerFadingCircle: require('./lib/fading-circle.vue')
  },
